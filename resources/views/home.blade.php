                    ...
                    <div class="brand header-brand">
                        <div>
                            <h1 class="m-0">
                                @auth
                                    <a href="/dash">
                                        <img class="header-logo-image" src="{{asset('home/dist/images/logo.svg')}}" alt="Logo">
                                    </a>
                                @else
                                    <a href="/">
                                        <img class="header-logo-image" src="{{asset('home/dist/images/logo.svg')}}" alt="Logo">
            ...
            <section class="hero">
                <div class="container">
                    <div class="hero-inner">
						<div class="hero-copy">
	                        <h1 class="hero-title mt-0">Nlyone</h1>
	                        <p class="hero-paragraph">Memberikan Pengalaman Yang Belum anda Rasakan Sebelumnya</p>
                                <div class="hero-cta">
                                    @auth
                                        <a class="button button-primary" href="dash">Dashboard</a>
                                        <a class="button" href="logout">Logout</a>
                                    @endauth

                                    @guest

                                            <a class="button button-primary" href="register">Gabung Nlyone</a>
					...
					<div class="features-inner section-inner has-bottom-divider">
                        <div class="features-wrap">
                            <div class="feature text-center is-revealing">
                                <div class="feature-inner">
                                    <div class="feature-icon">
										<img src="{{ asset('home/dist/images/feature-icon-01.svg') }}" alt="Feature 01">
                                    </div>
							...
							<div class="feature text-center is-revealing">
                                <div class="feature-inner">
                                    <div class="feature-icon">
										<img src="{{ asset('home/dist/images/feature-icon-02.svg') }}" alt="Feature 02">
                                    </div>
                                    <h4 class="feature-title mt-24">Be Productive</h4>
                                    <p class="text-sm mb-0">Fermentum posuere urna nec tincidunt praesent semper feugiat nibh. A arcu cursus vitae congue mauris. Nam at lectus urna duis convallis. Mauris rhoncus aenean vel elit scelerisque mauris.</p>
                                </div>
                            ...
                            <div class="feature text-center is-revealing">
                                <div class="feature-inner">
                                    <div class="feature-icon">
										<img src="{{ asset('home/dist/images/feature-icon-03.svg') }}" alt="Feature 03">
                                    </div>
                                    <h4 class="feature-title mt-24">Be Productive</h4>
                                    <p class="text-sm mb-0">Fermentum posuere urna nec tincidunt praesent semper feugiat nibh. A arcu cursus vitae congue mauris. Nam at lectus urna duis convallis. Mauris rhoncus aenean vel elit scelerisque mauris.</p>
                                </div>
        ...
        <footer class="site-footer">
            <div class="container">
                <div class="site-footer-inner">
                    ...
                    <div class="footer-copyright">&copy; 2021 Nlyone</div>
                </div>
            </div>
        </footer>
    </div>
